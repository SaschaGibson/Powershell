param (
    [string]$localFolderPath # Lokaler Ordnerpfad als Skriptparameter
)
...
# Passworteingabe
$Password = Read-Host -Prompt "Bitte geben Sie Ihr Passwort ein" -AsSecureString
$Creds = New-Object -TypeName System.Management.Automation.PSCredential -ArgumentList $User, $Password

# Überprüfung, ob der lokale Ordner existiert
if (-not (Test-Path -Path $localFolderPath)) {
    Write-Error "Lokaler Ordner existiert nicht: $localFolderPath"
    exit
}
...
# Datei-Upload-Funktion mit Wiederholungslogik und korrekter Erfolgsmeldung
